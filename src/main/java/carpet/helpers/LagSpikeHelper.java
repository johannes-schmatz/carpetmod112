...
public class LagSpikeHelper {
	...
	public enum TickPhase {
		PLAYER(PrePostSubPhase.class, PrePostSubPhase.PRE), MOB_SPAWNING(PrePostSubPhase.class, PrePostSubPhase.PRE),
		CHUNK_UNLOADING(PrePostSubPhase.class, PrePostSubPhase.PRE), TILE_TICK(PrePostSubPhase.class, PrePostSubPhase.PRE),
		RANDOM_TICK(PrePostSubPhase.class, PrePostSubPhase.PRE), PLAYER_CHUNK_MAP(PrePostSubPhase.class, PrePostSubPhase.PRE),
		VILLAGE(PrePostSubPhase.class, PrePostSubPhase.PRE), BLOCK_EVENT(PrePostSubPhase.class, PrePostSubPhase.PRE),
		ENTITY(EntitySubPhase.class, EntitySubPhase.PRE), TILE_ENTITY(PrePostSubPhase.class, PrePostSubPhase.PRE),
		AUTOSAVE(PrePostSubPhase.class, PrePostSubPhase.PRE),

		TICK(PrePostSubPhase.class, PrePostSubPhase.PRE), DIMENSION(PrePostSubPhase.class, PrePostSubPhase.PRE),
		;
