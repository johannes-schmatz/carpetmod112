...
public class RedstoneWireTurbo
{
    ...
    */
    ...
    private void identifyNode(final World worldIn, final UpdateNode upd1) {
        ...
        // be replicated here.
        if (!wire.canBePlacedAtPos(worldIn, pos)) {
            // Pop off the redstone dust
            wire.dropAsItem(worldIn, pos, oldState, 0);
            worldIn.setAir(pos);
    ...
    private BlockState calculateCurrentChanges(final World worldIn, final UpdateNode upd)
    {
        ...
        if (k<15) {
            ...
            boolean center_up_is_cube = center_up.currentState.method_11734();
            ...
            for (int m=0; m<4; m++) {
                ...
                // neighbors
                boolean neighbor_is_cube = neighbor.currentState.method_11734();
                if (!neighbor_is_cube) {
