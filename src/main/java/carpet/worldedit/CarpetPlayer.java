...
class CarpetPlayer extends AbstractPlayerActor {
	...
	public Location getLocation() {
		...
		return new Location(CarpetWorldEdit.inst.getWorld(this.player.world), position, this.player.strideDistance, this.player.pitch);
	}
	...
	public void dispatchCUIEvent(CUIEvent event) {
		...
		PacketByteBuf pb = new PacketByteBuf(Unpooled.wrappedBuffer(send.getBytes(StandardCharsets.UTF_8)));
