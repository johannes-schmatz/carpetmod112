	...
	public void onExploded(double x, double y, double z) {
		LoggerRegistry.getLogger("tnt").log((option) -> {
			switch (option) {
				case "brief":
					return new Text[]{
							Messenger.m(null, "l P ", Messenger.dblt("l", primedX, primedY, primedZ, primedAngle), "r  E ", Messenger.dblt("r", x, y, z))
					};
				case "full":
					return new Text[]{
							Messenger.m(null, "l P ", Messenger.dblf("l", primedX, primedY, primedZ, primedAngle), "r  E ", Messenger.dblf("r", x, y, z))
					};
			}
			return null;
		}, "PRIMED_X", primedX, "PRIMED_Y", primedY, "PRIMED_Z", primedZ, "PRIMED_ANGLE", primedAngle, "EXPLODE_X", x, "EXPLODE_Y", y, "EXPLODE_Z", z);
	}
